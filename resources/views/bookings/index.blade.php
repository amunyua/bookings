...
@section('content')
    ...
    @section("pageSubtitle","create, update and delete Bookings")
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Create Bookings</h4>
                    </div>
    ...
    <div class="modal fade" id="edit-modal" role="dialog">
           ...
           <div class="modal-dialog">
               <div class="modal-content">
                   ...
                   <div class="modal-footer">
                        <input type="hidden" id="editDetails" value="{{ url("/bookings") }}">
                       <button type="button" class="btn btn-default pull-left" data-dismiss="modal">No</button>
                       <button type="submit" class="btn btn-primary">Save</button>
                   </div>
               </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Delete Bookings</h4>
                        </div>
                        <div class="modal-body">
                            <p>Are you sure you want to delete this Bookings?</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default pull-left" data-dismiss="modal">No</button>
                            <button type="submit" class="btn btn-primary">Save</button>
